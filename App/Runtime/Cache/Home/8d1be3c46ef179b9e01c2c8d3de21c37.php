...
<html lang="zh-CN">
  <head>
    ...
    <![endif]-->
    <link rel="stylesheet" href="/oweb/Public/css/main.css">
  ...
  <body>
  	<div class="contain">
        ...
        <div class="topbar">
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse animated bounceInRight" id="navList">
        ...
        <!--内容-->
        <div class="main">
            <div class="tipbtn animated bounceInLeft">
                <ul>
                    <li>
            ...
            <div class="pro animated bounceInUp">
                <ul class="prolist">
                    <li><a href="javascript:void(0)"><img class="picleft" src="/oweb/Public/image/index/pro_01.png" alt="酒城风雨麻将"></a></li>
                    <li><a href="javascript:void(0)"><img class="picright" src="/oweb/Public/image/index/pro_02.png" alt="巴山麻将"></a></li>
                    <li><a href="javascript:void(0)"><img class="picleft" src="/oweb/Public/image/index/pro_04.png" alt="来闽福建麻将"></a></li>
                    <li><a href="javascript:void(0)"><img class="picright" src="/oweb/Public/image/index/pro_03.png" alt="黄金水果棋牌"></a></li>
                    <li><a href="javascript:void(0)"><img class="picleft" src="/oweb/Public/image/index/pro_05.png" alt="安徽棋牌"></a></li>
                    <li><a href="javascript:void(0)"><img class="picright" src="/oweb/Public/image/index/pro_06.png" alt="四季麻将"></a></li>
                    <li><a href="javascript:void(0)"><img class="picleft" src="/oweb/Public/image/index/pro_07.png" alt="鬼牛麻将"></a></li>
                    <li><a href="javascript:void(0)"><img class="picright" src="/oweb/Public/image/index/pro_08.png" alt="奕棋玩麻将"></a></li>
                </ul>
            </div>
        </div>
        <!--页脚-->
